...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated {
    ...
    if(self.closeButtonLocation == KGModalCloseButtonLocationRight){
        ...
        closeFrame.origin.x = CGRectGetWidth(containerView.bounds)-25-18;
        closeFrame.size.width = 30.0f;
        closeFrame.size.height = 30.0f;
        closeFrame.origin.y = 22.0f;
...
- (UIImage *)closeButtonImage{
    ...
    //[UIColor colorWithRed:0.21 green:0.21 blue:0.21 alpha:0.9];
    UIColor *bottomGradient = [UIColor clearColor];
    //[UIColor colorWithRed:0.03 green:0.03 blue:0.03 alpha:0.9];
